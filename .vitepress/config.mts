          ...
          '/es/gameplay/': [
            {
              ...
              items: [
                ...
                { text: 'Guerrero', link: '/es/gameplay/clases/warrior' },
                { text: 'Mago', link: '/es/gameplay/clases/mage' },
                { text: 'Clérigo', link: '/es/gameplay/clases/cleric' },
                { text: 'Pícaro', link: '/es/gameplay/clases/rogue' },
                { text: 'Bárbaro', link: '/es/gameplay/clases/barbarian' },
                { text: 'Hechicero', link: '/es/gameplay/clases/sorcerer' },
                { text: 'Brujo', link: '/es/gameplay/clases/warlock' },
                { text: 'Bardo', link: '/es/gameplay/clases/bard' },
                { text: 'Paladín', link: '/es/gameplay/clases/paladin' },
                { text: 'Druida', link: '/es/gameplay/clases/druid' },
                { text: 'Explorador', link: '/es/gameplay/clases/ranger' },
                { text: 'Monje', link: '/es/gameplay/clases/monk' },
                { text: 'Artífice', link: '/es/gameplay/clases/artificer' },
                { text: 'Verdugo de Sangre', link: '/es/gameplay/clases/blood-slayer' },
              ],
            },
            {
              text: 'Razas',
              ...
              items: [
                ...
                { text: 'Humano', link: '/es/gameplay/razas/human' },
                { text: 'Elfo', link: '/es/gameplay/razas/elf' },
                { text: 'Enano', link: '/es/gameplay/razas/dwarf' },
                { text: 'Orco', link: '/es/gameplay/razas/orc' },
                { text: 'Gnomo', link: '/es/gameplay/razas/gnome' },
                { text: 'Dhampiro', link: '/es/gameplay/razas/dhampir' },
              ],
            },
            {
              text: 'Personaje',
