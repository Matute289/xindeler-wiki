...
When activated, the Dhampir releases a burst of cold that applies **Frozen** to nearby enemies, slowing or briefly immobilizing them. A combination of escape tool and offensive crowd control.

## CC Resistance

The Dhampir's +10% CC resistance passive is one of the most unique in the game. It reduces the duration of effects like Frozen, Crippled, Ensnared and others, making the Dhampir significantly harder to control in PvP and encounters with multiple enemies.

## Class Synergy

**Warrior + Dhampir** creates a frontline combatant that is nearly impossible to immobilize. **Mage + Dhampir** allows resisting enemy crowd controls while channeling magic.
