...
| | |
|---|---|
| **Passive** | +3% Energy recovery |
| **Innate ability** | Second Wind |

## Second Wind

An emergency recovery ability. When activated, the Human recovers Energy at an accelerated rate for a brief period, allowing more active abilities to be chained together.

## Class Synergy

Works well with any class, but is especially useful for **Cleric** (where Energy directly fuels healing spells) and **Mage** (more spells per combat cycle).
