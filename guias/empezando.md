...
> Launcher support with automatic updates is under development. For now installation is manual.
...
Merchants buy and sell according to their specialization — see [NPCs](/base-de-datos/npcs) for the different roles. Grouping up with other players lets you share quests, loot and difficult content — most dungeons are easier, and more fun, with a group.
