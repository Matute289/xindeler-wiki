...
Las armas son **modulares**: los stats finales salen de la combinación de materiales usados, no de una plantilla fija. Un arma crafteada con hierro común se comporta muy distinto a la misma arma forjada con un material más raro — ver [Crafteo](/es/gameplay/crafteo) para el sistema de tiers de calidad que rige esto.
